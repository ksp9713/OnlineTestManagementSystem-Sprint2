...
public class QuestionDao implements QuestionDaoInterface
{
	...
	public Boolean updateQuestion(QuestionBank question) throws QuestionException 
	{
		...
		{	
			...
			questionUpdate.setQuestionOptionA(question.getQuestionOptionA());
			questionUpdate.setQuestionOptionB(question.getQuestionOptionB());
			questionUpdate.setQuestionOptionC(question.getQuestionOptionC());
			questionUpdate.setQuestionOptionD(question.getQuestionOptionD());
