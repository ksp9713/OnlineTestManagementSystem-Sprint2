...
public class WorkSpaceController{
	...
	public ResponseEntity<WorkSpaceData> updateEntry(@RequestBody WorkSpaceData entry, @PathVariable("sequenceId") Long sequenceId) throws WorkSpaceException {
		try {
			System.out.println(sequenceId);
			System.out.println(entry.getTestId());
			System.out.println(entry.getMarksScored());
			System.out.println(entry.getTestStatus());
			WorkSpaceData response = workspaceServiceInterface.updateEntry(sequenceId,entry);
