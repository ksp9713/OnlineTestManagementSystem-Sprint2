 ...
 *          Description  :    It is an Entity class which stores all assigned test data to all the users.
 *          Version      :    
...
public class WorkSpaceData implements Serializable{
	...
	public WorkSpaceData(Long userId, BigInteger testId, String testTitle, Double totalMarks,
			LocalTime testDuration, Integer testStatus) {
		super();
		this.userId = userId;
		this.testId = testId;
